...
async function synchronizeData() {
    try {
        const localDb = await (0, sqlite_1.dbSqlite)();
        // 1. Tenta inicializar pool de produção
        const pool = await (0, sqlserver_1.db)("remote").catch(async (e) => {
        ...
        if (metrics && metrics.length > 0) {
            for (const row of metrics) {
                ...
                ps.input("client_id", mssql_1.default.Int);
                ps.input("cpu", mssql_1.default.Float);
                ps.input("mem", mssql_1.default.Float);
                ps.input("sess", mssql_1.default.Int);
                ps.input("query", mssql_1.default.Float);
                ps.input("dead", mssql_1.default.Int);
                ps.input("state", mssql_1.default.VarChar);
                ps.input("disk", mssql_1.default.Float);
                ps.input("bak", mssql_1.default.DateTime);
                ps.input("login", mssql_1.default.Int);
                await ps.prepare(`
        ...
        if (checks && checks.length > 0) {
            for (const row of checks) {
                const ps = new mssql_1.default.PreparedStatement(pool);
                ps.input("client_id", mssql_1.default.Int);
                ps.input("checkName", mssql_1.default.VarChar);
                ps.input("status", mssql_1.default.VarChar);
                ps.input("details", mssql_1.default.VarChar);
                await ps.prepare(`
        ...
        if (backups && backups.length > 0) {
            for (const row of backups) {
                const ps = new mssql_1.default.PreparedStatement(pool);
                ps.input("client_id", mssql_1.default.Int);
                ps.input("dbName", mssql_1.default.VarChar);
                ps.input("lastBackup", mssql_1.default.DateTime);
                ps.input("type", mssql_1.default.VarChar);
                ps.input("status", mssql_1.default.VarChar);
                await ps.prepare(`
        ...
        if (alerts && alerts.length > 0) {
            for (const row of alerts) {
                const ps = new mssql_1.default.PreparedStatement(pool);
                ps.input("client_id", mssql_1.default.Int);
                ps.input("severity", mssql_1.default.VarChar);
                ps.input("message", mssql_1.default.VarChar);
                await ps.prepare(`
